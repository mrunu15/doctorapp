...
const transporter = nodemailer.createTransport({
    service: 'gmail',
    auth: {
        user: 'mrunu153@gmail.com', // this is the email that will be used to send the email.
        pass: 'zzmr ugec raav guxh', //this is the password that is created in app passwords in gmail setting options.
    },
});
...
/*
This api will send the otp to both registered and unregisterd users.If the user is registered its otp details will be save to the user collection 
